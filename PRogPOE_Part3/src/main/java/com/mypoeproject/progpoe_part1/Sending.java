...
public class Sending {
    ...
    public static void sendMessage(){
	    ...
	    System.out.println("");
	    System.out.println("The international digit code should start with a '+'");
	    System.out.print("Enter international digit code: ");
	    interDigitCode = input.nextLine();
	    System.out.println("");
	    System.out.print("Enter cellphone number: " + interDigitCode);
        ...
        for(int index = 0; index < messageNum; index++){
            ...
            messageObject.put("sender", LogIn.usernameInput);
            ...
            Messaging.storedMessages.put(messageObject);
        }
